...
ns-hello:
	...
	$(CC) $(ASM_FLAGS) -c src/crt.S -o build/ns-hello/crt.o -DSYS_INIT_SP_ADDR=0x80C10000
	$(CC) $(CC_FLAGS) -c src/hello.c -o build/ns-hello/hello.o
...
s-hello:
	...
	$(CC) $(ASM_FLAGS) -c src/crt.S -o build/s-hello/crt.o -DSYS_INIT_SP_ADDR=0x80210000
	$(CC) $(CC_FLAGS) -c src/hello.c -o build/s-hello/hello.o
